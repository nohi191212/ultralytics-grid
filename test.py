...
best = (
    "/mnt/HithinkOmniSSD/user_workspace/caisihang/project/ultralytics/runs/two_stage_0512/stage2_full/weights/best.pt"
)
...
for key, label in [
    ("metrics/gender_acc", "gender_acc"),
    ("metrics/race_acc", "race_acc"),
    ("metrics/body_acc", "body_acc"),
]:
    v = acc.get(key)
    if v is not None:
